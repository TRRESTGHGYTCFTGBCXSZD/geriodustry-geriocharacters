/**
package geriodustrycharacters.ui;
...
public class AnimdustryStyledInfo extends BaseDialog{

    public AnimdustryStyledInfo(){
        super("@info.title");
    ...
    public void show(UnlockableContent content){
        ...
        table.table(title1 -> {
            ...
            title1.add("[white]-" + content.localizedName + (settings.getBool("console") ? "-\n[gray]" + Core.bundle.getOrNull(content.getContentType() + "." + content.name + ".animdustrydetails") : "")).padLeft(5);
        });
